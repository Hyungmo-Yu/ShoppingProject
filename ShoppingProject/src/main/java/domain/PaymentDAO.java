...
//	private DBConnectionPool connPool;
	private static final String ALLRETRIEVE_STMT = "SELECT * FROM c##shoppingpayment";
	private static final String RETRIEVE_STMT = "SELECT * FROM c##shoppingpayment WHERE UserID = ?";
	private static final String GETID_STMT = "SELECT COUNT(PaymentID) FROM c##shoppingpayment";
	private static final String ADD_STMT = "INSERT INTO c##shoppingpayment VALUES(?,?,?,?,?,?,?,?)";
	...
	ArrayList<Payment> allpaymentRetrieve() throws SQLException
	{
		...
		try
		{
			...
			while (rset.next())
			{
				...
				payments.add(
						new Payment(PaymentID, UserID, ProductID, Numbers, Address, Contact, CreditCardNumber, CreditCardPassword));
			}
			return payments;
