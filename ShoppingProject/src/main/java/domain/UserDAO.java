...
//	private static final String RETRIEVE_STMT = "SELECT * FROM shoppinguser WHERE UserType=? AND UserName=? AND Password =?";
	private static final String RETRIEVE_STMT = "SELECT * FROM c##shoppinguser WHERE UserType=? AND UserName=? AND Password =?";
	private static final String GETID_STMT = "SELECT COUNT(UserID) FROM c##shoppinguser";
	private static final String CREATE_STMT = "INSERT INTO c##shoppinguser VALUES(?,?,?,?,?,?,?,?,?)";
	...
	void userCreate(String usertype, String username, String password, Date birthdate, String gender, String email,
