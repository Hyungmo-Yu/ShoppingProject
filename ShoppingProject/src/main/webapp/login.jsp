...
<body>
	...
	<form action="search" method="post">
		Search the product you want : <input type="text" name="productname"
			size="24"> <input type="submit" value="Submit">
	</form>
	<table border="2px">
		<tr>
			...
			<td align="center">
				<form action="take" method="post">
					Enter the numbers you want : <input type="hidden" name="userid"
						...
						name="productid" value="<%=product.getProductid()%>"> <input
						type="text" name="numbers" size="5"> <input type="submit"
						value="Take">
				</form>
			</td>
		</tr>
