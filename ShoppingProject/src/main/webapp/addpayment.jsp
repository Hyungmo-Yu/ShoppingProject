...
<body>
	...
	<table border="2px">
		...
		<tbody>
			<tr>
				<td align="center">Your Address : <%=user.getAddress()%></br> Your
					Contact : <%=user.getContact()%></br> Total Price : <%=totalprice%>
				</td>
			</tr>
			<tr>
				<td align="center">
					<form action="pay" method="post">
						Enter your Credit Card Number <input type="text"
							name="creditcardnumber"></br> Enter your Credit Card Password
						<input type="password" name="creditcardpassword"></br> <input
